//TODO: Add -c flag for pizza, payment, and customer
...
const messages = Messages.loadMessages("sfdx-dominos", "order");

export default class Orders extends SfdxCommand {
  ...
  protected static flagsConfig = {
    ...
    place: flags.boolean({
      char: "p",
      description: messages.getMessage("placeFlagDescription")
    })
  };
  ...
  public async run(): Promise<AnyJson> {
    if (this.flags.place) {
      ...
      const customer = new Customer({
        ...
        address: "123 Main Street, Madison, WI, 53073",
        firstName: "Mike",
        lastName: "Stimpson",
        phone: "123-456-7890",
      ...
      //fake card from documentation for example
      ...
      try {
        ...
        return { response: trackingResult, error: null };
      } catch (err) {
